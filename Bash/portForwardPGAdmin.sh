...
clear
echo -e "${BLUE}\n\nCLUSTER LIST:\n\n${NC}${PURPLE}1) ${NC}CLUSTER1-01\n${PURPLE}2) ${NC}CLUSTER2-01\n${PURPLE}3) ${NC}CLUSTER3-01\n${PURPLE}4) ${NC}CLUSTER4\n${PURPLE}5) ${NC}CLUSTER5"
