...
Aaleem Siddiqui
SavingsAccount.java 
This program stores a savings accounts annual interest rate and balance. 

*program does not fully function. been working on this code for a few hours and im not sure why its not working correctly. 
...
public static void main(String args[]) {
    ...
    System.out.println("Total amount deposited: " + dollar.format(totalDeposits));
    System.out.println("Total amount withdrawn: " + dollar.format(totalWithdrawn));
